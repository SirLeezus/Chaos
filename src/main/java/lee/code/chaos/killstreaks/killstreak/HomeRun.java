...
public class HomeRun extends KillStreak {
    ...
    public HomeRun() {
        ...
        ItemStack unlocked = BukkitUtils.getItem(Material.STICK,
                Lang.MENU_KILL_STREAK_NAME.getString(new String[] { BukkitUtils.parseCapitalization(name()) }),
        ...
        ItemStack selected = BukkitUtils.getItem(Material.STICK,
                Lang.MENU_KILL_STREAK_NAME.getString(new String[] { BukkitUtils.parseCapitalization(name()) }),
    ...
    public String description() {
        return "&7You'll be given a knockback X stick.";
    }
    ...
    public void runLogic(Player player) {
        ...
        BukkitUtils.givePlayerItem(player, stick, 1);

...
public class AbstractBoard {
    ...
    private void newSideBarPacket(Player player) {
        ...
        try {
            ...
            protocolManager.sendServerPacket(player, createSidebarPacket(-1, "&2---------------", EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-2, lastKillScore, EnumWrappers.ScoreboardAction.REMOVE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-2, kills, EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-3, lastKillSteakScore, EnumWrappers.ScoreboardAction.REMOVE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-3, killSteak, EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-4, lastDeathScore, EnumWrappers.ScoreboardAction.REMOVE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-4, death, EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-5, "&r&2---------------", EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-6, lastRedScore, EnumWrappers.ScoreboardAction.REMOVE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-6, redScore, EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-7, lastBlueScore, EnumWrappers.ScoreboardAction.REMOVE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-7, blueScore, EnumWrappers.ScoreboardAction.CHANGE));
            protocolManager.sendServerPacket(player, createSidebarPacket(-8, "&2---------------&r", EnumWrappers.ScoreboardAction.CHANGE));
            lastKillScore = kills;

...
public enum Lang {
    ...
    BLUE_TEAM("&9&lBlue"),
    RED_TEAM("&c&lRed"),
    MENU_KIT_SELECTED("&aYou successfully selected the kit &e&l{0}&a!"),
    MENU_KIT_NAME("&e&l{0}"),
    MENU_KIT_LORE_LOCKED(" \n&c&lCost&7: &2{0} &6⛃\n \n&e> &aTo preview right-click!"),
    MENU_KIT_LORE_UNLOCKED(" \n&e> &aTo select left-click!\n&e> &aTo preview right-click!"),
    MENU_KIT_TITLE("&a&lKits &8Page {0}"),
    MENU_TEAM_PREVIEW_TITLE("&e&lKit Preview"),
